...
if st.button("🚀 GENERATE FINAL COMPUTATION"):
    ...
    salary_taxable = salary_gross - hra_exemp 
    ...
    summary_data = {
        "Particulars": ["Gross Total Income", "Less: HRA Exemption", "Net Slab-Rate Income", "Special Rate Income (Crypto/Lottery)", "Less: Std Ded/80C", "Tax on Slab Income", "Tax on Special Income (30%)", "Total Tax Liability (incl. Cess)", "Less: Taxes Paid", "Add: Sec 234 Interest", "Net Amount Payable/(Refund)"],
